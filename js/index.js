...
const setCanvas = (done) => {
    ...
    canvas.width = Math.floor(canvasDimensions.width * dpr);
    canvas.height = Math.floor(canvasDimensions.height * dpr);
...
const animate = () => {
    ...
    context.fillText('Wheel of Misfortune', canvasDimensions.width / 2, 50);
